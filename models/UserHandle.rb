...
class UserHandle
  ...
  def InsertExam(chartno,accessionno,age,orderdate,ordertime,examtype,examdate,examtime,status,drorderidname,dronidname,drreportidname,examdetail,drfrom,chargeby,modality,divisionon,zone,medsummary,isdanger)
    @chartno=chartno
    @accessionno=accessionno
    @age=age
    @orderdate=orderdate
    ...
    sql="insert into "
    sql+="cris_exam_online( "
    sql+="system,chartno,uni_key,age,orderdate,ordertime,type,examdate,examtime,status,accessionnumber,dr_from,dr_order,dr_on,dr_report,uploadcode,examdetail,his_reqno,chargeby,modality,division_on,zone,clinicalimp,isdanger "
    sql+=") values( "
    sql+="'HIS_IN', "
    sql+="'#{@chartno}', "
    sql+="'#{@accessionno}', "
  ...
  def UpdateExam(chartno,accessionno,age,orderdate,ordertime,examtype,examdate,examtime,status,drorderidname,dronidname,drreportidname,examdetail,drfrom,chargeby,modality,divisionon,zone,medsummary,isdanger)
    @chartno=chartno
    @accessionno=accessionno
    @age=age
    @orderdate=orderdate
